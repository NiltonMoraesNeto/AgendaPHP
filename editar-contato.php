...
$contatos = listaContatosEditar($conexao);
...
?>
	...
	<form method="post" id="formContatoEdit">
		<table class="table table-striped">
			...
			<td colspan="1">
					<div class="form-group">
						...
						<select class="form-control" name="nomePEmpresa" id="nomePEmpresa" required>
	                        <option>Selecione um Nome Empresa/Pessoa...</option>
	                        <?php foreach ($contatos as $nomePEmpresa) : ?>
	                            <option value="<?=$nomePEmpresa['ID_CONTATO']?>"><?=$nomePEmpresa['NOME_CONTATO']?></option>
	                        <?php endforeach ?>
	                    </select>				
	  				</div>
					</td>
	  			...
	  			<td>
					<div class="form-group">
	    				<label class="borderless">
	    					<label for="cpf">CPF&nbsp;</label><input type="radio" class="borderless" id="cpfg" name="cpfcnpj" value="cpf" /> | 
	    					<label for="cnpj">CNPJ&nbsp;</label><input type="radio" class="borderless" id="cnpj" name="cpfcnpj" value="cnpj" />
	    				</label>
		    			<input type="text" class="form-control cpf-cnpj" id="cpf" name="cpf" />
	  				</div>
	  			</td>
	  		</tr>
	  		<tr>
	  		...
	  		<tr>
	  			<td colspan="4">
	  				<button type="submit" class="btn btn-success action" id="edit-contato" name="edit-contato">Salvar Alterações</button>
