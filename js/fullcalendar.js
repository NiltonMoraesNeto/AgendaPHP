		...
		if (name != 'views') {
			...
			if (
				...
				$.each(val, function(subName, subVal) {
					...
					if (/^(month|week|day|default|basic(Week|Day)?|agenda2(Week|Day)?)$/.test(subName)) {
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	computeLabelInterval: function(slotDuration) {
		...
		for (i = agenda2_STOCK_SUB_DURATIONS.length - 1; i >= 0; i--) {
			labelInterval = moment.duration(agenda2_STOCK_SUB_DURATIONS[i]);
...
/* An abstract class for all agenda2-related views. Displays one more columns with time slots running vertically.
----------------------------------------------------------------------------------------------------------------------*/
// Is a manager for the TimeGrid subcomponent and possibly the DayGrid subcomponent (if allDaySlot is on).
// Responsible for managing width/height.

var agenda2View = FC.agenda2View = View.extend({
	...
	instantiateTimeGrid: function() {
		var subclass = this.timeGridClass.extend(agenda2TimeGridMethods);
	...
	instantiateDayGrid: function() {
		var subclass = this.dayGridClass.extend(agenda2DayGridMethods);
	...
	renderDates: function() {
		...
		this.el.addClass('fc-agenda2-view').html(this.renderSkeletonHtml());
		this.renderHead();
	...
	setHeight: function(totalHeight, isAuto) {
		...
		if (this.dayGrid) {
			...
			if (eventLimit && typeof eventLimit !== 'number') {
				eventLimit = agenda2_ALL_DAY_EVENT_LIMIT; // make sure "auto" goes to a real number
			}
			if (eventLimit) {
...
// Methods that will customize the rendering behavior of the agenda2View's timeGrid
// TODO: move into TimeGrid
var agenda2TimeGridMethods = {
...
// Methods that will customize the rendering behavior of the agenda2View's dayGrid
var agenda2DayGridMethods = {
...
var agenda2_ALL_DAY_EVENT_LIMIT = 5;

// potential nice values for the slot-duration and interval-duration
// from largest to smallest
var agenda2_STOCK_SUB_DURATIONS = [
	{ hours: 1 },
	{ minutes: 30 },
	{ minutes: 15 },
	{ seconds: 30 },
